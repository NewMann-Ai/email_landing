...
export const newmannMailDictionary = {
  it: {
    badge: "Newmann Mail",
    titleStart: "Automatizza la Gestione delle ",
    ...
    draftWriter: {
      ...
      quote: "Quante ore al mese perdi a scrivere le stesse risposte?",
      body: "L'Email Draft Writer genera bozze complete, personalizzate e pronte per l'invio. Newmann analizza la storia della conversazione, il tono della tua azienda, il contesto del business e crea una risposta che sembra scritta da te.",
      steps: [
    ...
    inboxOrganizer: {
      ...
      quote:
        "Una inbox disorganizzata è come avere 10.000 fogli sparsi sulla scrivania.",
    ...
    chat: {
      ...
      body: "Il chatbot Newmie (WIP) ti permette di migliorare ancora di più l'efficienza nella gestione delle tue email:",
      benefits: [
  ...
  en: {
    ...
    draftWriter: {
      titleHighlight: "AI",
      titlePrefix: "Draft Writer",
      quote: "How many hours a month do you waste writing the same replies?",
    ...
    inboxOrganizer: {
      ...
      titleSuffix: "Labels",
      quote:
        "A disorganized inbox is like having 10,000 sheets of paper scattered on your desk.",
